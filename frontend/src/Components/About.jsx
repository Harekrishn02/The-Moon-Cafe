  ...
  <div className="relative flex-shrink-0">
    <div className="absolute top-0 right-0 overflow-hidden">
      ...
      <img
        src="/aboutimage.png"
        alt="Cafe Interior"
        className="w-[200px] lg:w-[160px] 2xl:w-[186px] md:w-[130px] object-cover right-[-10%] lg:right-[-10%] top-[20%] lg:top-[20%] md:right-[-5%] md:top-[10%] transition-all"
      />
      ...
      <img
        ...
        src="/about1.png"
        alt="Cafe Interior"
        className="absolute top-[26.5%] right-[50%] w-[190px] h-[190px] lg:w-[175px] lg:h-[155px] md:w-[195px] md:h-[130px] rounded-full 2xl:w-[180px] 2xl:h-[180px] md:top-[23.5%] md:right-[49%] lg:object-cover md:object-cover transition-all"
      />
    </div>
  </div>
