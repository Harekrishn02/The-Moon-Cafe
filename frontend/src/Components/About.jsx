...
function About() {
  ...
  return (
    <>
      ...
      <section className="hidden md:flex py-16 lg:py-2 2xl:py-26 xl:py-10 relative overflow-hidden flex-row items-center bg-[#f8f5f0]">
        {/* Image Section */}
        <div className="relative">
          <div className="absolute overflow-hidden">
            <img
              src="/aboutimage.png"
              alt="Cafe Interior"
              className="w-full lg:w-[160px] 2xl:w-[186px] md:w-[130px] md:object-cover relative right-[44px] lg:right-[44px] top-[20px] lg:top-[20px] object-cover"
            />
            <img
              data-aos="fade-up-right"
              src="/about1.png"
              alt="Cafe Interior"
              className="absolute top-[26.5px] right-[51px] w-[190px] h-[190px] lg:w-[175px] lg:h-[155px] md:w-[195px] md:h-[130px] md:top-[23.5px] md:right-[49px] rounded-full 2xl:w-[180px] 2xl:h-[180px] lg:object-cover md:object-cover"
            />
          </div>
        </div>

        {/* Content Section */}
        <div className="relative z-10 text-left text-[#3d2f23] p-10 px-24 lg:px-20 2xl:px-60 md:px-10 md:ml-[96px] ml-[150px] lg:ml-[115px]">
          <p className="font-pacifico text-lg italic text-[#523625] sm:text-lg md:text-2xl tracking-wide">
            --- About Us ---
          </p>
          <p className="font-nunito text-xl lg:text-3xl mt-3 font-bold text-[#352f27] mb-6 leading-snug animate-slideInLeft">
          ...
          <div className="flex xl:mb-10 items-center gap-3 mb-8 md:mb-5">
            <span className="w-[2px] h-[15px] md:w-[1px] md:h-[8px] lg:w-[1.5px] lg:h-[10px] bg-[#3d2f23]"></span>
            <div>
